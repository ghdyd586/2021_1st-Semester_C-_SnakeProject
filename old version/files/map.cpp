...
void set_color(){
  ...
  init_pair(13, COLOR_BLUE, COLOR_BLUE); //snake head
  init_pair(14, COLOR_CYAN, COLOR_CYAN); //snake body
...
void window_setting(WINDOW* win1, WINDOW* win2, WINDOW* win3){ //window setting win1 = game board |win2 = mission board | win3= score board
...
void map_print(WINDOW* win1, int map[][30][30]){
  int selmap = 3; //should be modified
