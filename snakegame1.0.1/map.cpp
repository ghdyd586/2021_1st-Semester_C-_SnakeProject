...
void set_color(){
  ...
  init_pair(13, COLOR_CYAN, COLOR_CYAN);       // Snake Head
  init_pair(14, COLOR_BLUE, COLOR_BLUE);       // Snake Body
  init_pair(15, COLOR_GREEN, COLOR_GREEN);       // Item
      ...
      for (int j = 0; j < 30; j++) {
        // null box is white
          ...
          // Snake Head is cyan
              ...
              wattron(win1, COLOR_PAIR(13));
              mvwprintw(win1, i, temp, "%d ", map[selmap][i][j]);
              wattroff(win1, COLOR_PAIR(13));
              temp+=2;
          }
          // Snake Body is blue
          else if (map[selmap][i][j] == 4) {
              wattron(win1, COLOR_PAIR(14));
              mvwprintw(win1, i, temp, "%d ", map[selmap][i][j]);
          ...
          // Item is green
              ...
              wattron(win1, COLOR_PAIR(15));
              mvwprintw(win1, i, temp, "%d ", map[selmap][i][j]);
              wattroff(win1, COLOR_PAIR(15));
              temp+=2;
          }
      }
  }
