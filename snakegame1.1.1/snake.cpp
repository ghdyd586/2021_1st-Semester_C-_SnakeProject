...
// moving process--------------------------------------------------------------------------------
void snake_move(vector<snakebody>& snake, vector<snakebody>& gate, int* snake_direction){
  ...
  else if (map[selmap][new_head_row][new_head_col]==1){
    result(3);
    delwin(win1);
    exit(0);
  }
  else if (map[selmap][new_head_row][new_head_col]==2){
    result(3);
    delwin(win1);
    exit(0);
  }
